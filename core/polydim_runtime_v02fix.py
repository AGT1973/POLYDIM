"""
POLYDIM Runtime — V0.2 (fix: seen typo)
=======================
...
Resultados verificados (2026-06-13):
    API V0.1: align=0.9993  DIM_SQL=0.9089  DIM_PYTHON=0.781
    API V0.2: Session(READY, MODO_H)  Packet dual S+G  DIM_SQL=0.9977
    Fix: seed[d]=1 -> seen[d]=1 en dims_activas()

Autor:   ai.mpat.agt@gmail.com
Version: V0.2fix — 2026-06-13
"""
