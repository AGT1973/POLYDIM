...
ariel.garcia.traba@gmail.com · github.com/AGT1973  
...
**Academic Track (Zenodo + OSF Preprints):** formal language design — state semantics, four
...
@misc{garciatraba2026polydim,
  ...
  year    = {2026},
  month   = {06},
  url     = {https://github.com/AGT1973/POLYDIM},
  note    = {Preprint. Zenodo. v1.0. Independent researcher, Buenos Aires, Argentina}
}
```

---

## Appendix C — Author and Citation Information
...
| **ORCID** | 0009-0001-2787-6067 |
| **Email** | ariel.garcia.traba@gmail.com |
| **GitHub** | github.com/AGT1973 |
| **Repository** | https://github.com/AGT1973/POLYDIM |
| **Published** | Zenodo (DOI assigned on publication) |

### C.2 Recommended Citation

```
Garcia Traba, A. H. (2026). POLYDIM: A Transformer-Native Algebraic Programming
Language for High-Dimensional Latent Computing. Zenodo.
https://doi.org/10.5281/zenodo.[assigned on publication]
```
...
*POLYDIM_SOTA_UNIFIED_V1 · Ariel H. Garcia Traba · Buenos Aires, Argentina · 2026*
